...
const GAME_DATA = {
  ...
  juicy: {
    ...
    truths: [
      ...
      "Have you ever imagined what our first date would be like?",
      "If you could change one circumstance affecting our relationship, what would you change?",
      "Have you ever thought about what we'd be like years from now?",
      "What's something about our connection that scares you a little?",
      "If you could ask me one question and guarantee I'd answer honestly, what would you ask?",
      "What's a truth about us that you think neither of us says openly?",
      "Have you ever wondered what would happen if we stopped holding ourselves back?",
      "If we had met under completely different circumstances, do you think we'd have fallen for each other?",
      "What's one moment between us that you think had more meaning than we admitted?",
      "If circumstances weren't an issue, what would you want our relationship to become?",
      "What's something you've imagined doing together but never told me?",
      "If I told you I had feelings for you, what would genuinely go through your mind first?",
      "What's one thing about me that could make you fall even deeper?",
      "If we had to choose between staying exactly as we are or taking a big chance on us, which would you choose?",
      "What's the biggest 'what if' you've ever had about me?",
      "If you could hear my completely unfiltered thoughts about you for one minute, would you want to?",
      "What's one thing you think you could never honestly say to my face?",
      "If you had to tell me one completely honest truth about what I mean to you, with no fear of my reaction, what would you say?",
    ],
